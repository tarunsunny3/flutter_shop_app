...
class AuthScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // if (Provider.of<Auth>(context).isAuthenticated)
...
class _AuthCardState extends State<AuthCard> {
  ...
  void _submit() async {
    if (_formKey.currentState?.validate() as bool != true) {
      // Invalid!
      print("Invailid");
      return;
    }
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = "Coudn't find a user with that email";
      ...
      var errorMessage =
          'Could not authenticate right now... Please try again later';
      _showErrorDialog(errorMessage);
    }
